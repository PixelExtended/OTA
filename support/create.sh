...
URL1="https://sourceforge.net/projects/private-dir/files/PixelExperience-Fan_Edition/Decrypted/$FILENAME"
URL=$URL1
VERSION="10"
...
mv ~/plus/out/target/product/jasmine_sprout/PixelExperience*.txt ~/OTA/changelogs/jasmine_sprout/
